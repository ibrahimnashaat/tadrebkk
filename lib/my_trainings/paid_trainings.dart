...
class PaidTrainings extends StatefulWidget {
  const PaidTrainings({super.key});

  @override
  State<PaidTrainings> createState() => _PaidTrainingsState();
}

class _PaidTrainingsState extends State<PaidTrainings> {
  @override
